...
public class Test {
    ...
    public void faceEngineTest() throws Exception {
        ...
        facenum = QsFaceEngine.detectFaces(handler, Util.toBytes(img1), img1.getWidth(), img1.getHeight(), img1.getWidth() * 3, face1, 1);
        System.out.println("facenum:" + facenum);
        facenum = QsFaceEngine.detectFacesV2(handler, Util.toBytes(img2), img2.getWidth(), img2.getHeight(), img2.getWidth() * 3, face2, 1);
        System.out.println("facenum:" + facenum);
        facenum = QsFaceEngine.detectFacesReinforce(handler, Util.toBytes(img2), img2.getWidth(), img2.getHeight(), img2.getWidth() * 3,
                face2, 1);
        System.out.println("facenum:" + facenum);
